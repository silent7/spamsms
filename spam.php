...
#Dilarang copyright Silent7 - AndroTech1733 2018 15 08 12:30
...
echo $RR."\n::#:Github ::[http://github.com/Silent7:] #";

echo $R."\n::#:Facebook ::[Fvking Ray:] #";

echo $G."\n::#:YouTube ::[LittleX Silent ID:] #";

echo $GG."\n::#:Team ::[Midnight Attacker] #";
...
echo "[]Silent7 Sending Massage To[] # ".$G.$argv[2].$X."\n";
